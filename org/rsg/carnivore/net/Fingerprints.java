...
public class Fingerprints {
	public File databaseFile = new File("/Users/pp/code/rsg/etter.finger.os");
	public ArrayList<Fingerprint> database = new ArrayList<Fingerprint>(); 

	public static void main (String[] args) {		
		String[] testquery1 = { "0200",null,null,null,"0","0","0","0","S","LT" };
		ArrayList<Fingerprint> queryresults1 = Fingerprints.instance().query(testquery1);
		System.out.println("queryresults1: " + queryresults1.size());
	}
	
	//singleton pattern
	public static Fingerprints instance() { return INSTANCE; }
	private static final Fingerprints INSTANCE = new Fingerprints();
...
//		Log.debug("["+this.getClass().getName()+"] new CarnivorePacket: " + packet);
	...
	public String getMajorOS(ArrayList<Fingerprint> databaseResults){
		String osBlank = "???";
