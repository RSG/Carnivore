...
#                                                                          #
# WWWW: 4 digit hex field indicating the TCP Window Size                   # 0
# MSS : 4 digit hex field indicating the TCP Option Maximum Segment Size   # 1
#       if omitted in the packet or unknown it is "_MSS"                   #
# TTL : 2 digit hex field indicating the IP Time To Live                   # 2
# WS  : 2 digit hex field indicating the TCP Option Window Scale           # 3
#       if omitted in the packet or unknown it is "WS"                     #
# S   : 1 digit field indicating if the TCP Option SACK permitted is true  # 4
# N   : 1 digit field indicating if the TCP Options contain a NOP          # 5
# D   : 1 digit field indicating if the IP Don't Fragment flag is set      # 6
# T   : 1 digit field indicating if the TCP Timestamp is present           # 7
# F   : 1 digit ascii field indicating the flag of the packet              # 8
#       S = SYN                                                            #
#       A = SYN + ACK                                                      #
# LEN : 2 digit hex field indicating the length of the packet              # 9
#       if irrilevant or unknown it is "LT"                                #
# OS  : an ascii string representing the OS                                # 10
#                                                                          #
